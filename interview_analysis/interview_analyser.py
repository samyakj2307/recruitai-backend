...
audiopath = str(settings.BASE_DIR) + "/proj_files/audiofiles"
fullAudiopath = str(settings.BASE_DIR) + "/proj_files/fullAudio"
videopath = str(settings.BASE_DIR) + "/proj_files/interview_video.mp4"
imagespath = str(settings.BASE_DIR) + "/proj_files/InterviewVideoImages"
modelpath = str(settings.BASE_DIR) + "/proj_files/mymodelhistory1.h5"
audioModelpath = str(settings.BASE_DIR) + "/proj_files/andioAnalysisModel.h5"
faceCascadepath = str(settings.BASE_DIR) + "/proj_files/haarcascade_frontalface_default.xml"
eyeCascadepath = str(settings.BASE_DIR) + "/proj_files/haarcascade_eye.xml"

seviceAccountKeypath = str(settings.BASE_DIR) + "/proj_files/serviceAccountKey.json"
